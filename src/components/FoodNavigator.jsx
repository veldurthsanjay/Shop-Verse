...
import { faHome, faSearch, faTruckFast, faUser, faMapMarkerAlt } from '@fortawesome/free-solid-svg-icons';
...
const FoodNavigator = () => {
  ...
  const tabs = [
    ...
    { path: '/find-food', icon: faSearch, label: 'Find Food' },
    { path: '/near-by-food', icon: faMapMarkerAlt, label: 'Near Food', isCenter: true },
    { path: '/pickups', icon: faTruckFast, label: 'Pickups' },
